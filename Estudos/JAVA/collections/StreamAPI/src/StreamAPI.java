  ...
  *//*
        Set<Map.Entry<String,Livro>> meusLivros4 = new TreeSet<>(Comparator.comparing(
                new Function<Map.Entry<String,Livro>,Integer>(){
                    @Override
                    public Integer apply(Map.Entry<String,Livro>cont ){
                        return cont.getValue().getPaginas();
                    }
                }
        ));*/
        Set<Map.Entry<String,Livro>> meusLivros4 = new TreeSet<>(Comparator.comparing(
                cont ->cont.getValue().getPaginas()));
        meusLivros4.addAll(meusLivros.entrySet());
        for (Map.Entry<String, Livro> livro : meusLivros4)
            System.out.println("Autor: "+livro.getKey() + " -titulo- " + livro.getValue().getNome()+"-pag-"+livro.getValue().getPaginas());
    }
}
...
class ComparaTotalPaginas implements Comparator<Map.Entry<String,Livro>> {
